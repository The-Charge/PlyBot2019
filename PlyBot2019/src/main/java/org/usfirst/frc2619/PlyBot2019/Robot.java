...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        NetworkTable networkTable = inst.getTable("datatable");

        xEntry = networkTable.getEntry("X");
        yEntry = networkTable.getEntry("Y");

        inst.startClientTeam(2619);

        /*
        UsbCamera jevoisCamera = CameraServer.getInstance().startAutomaticCapture();
        jevoisCamera.setVideoMode(VideoMode.PixelFormat.kMJPEG, CAM_WIDTH, CAM_HEIGHT, CAM_FPS);

        CvSink cvsink = CameraServer.getInstance().getVideo();
        CvSource outputStream = CameraServer.getInstance().putVideo("Camera Thing", CAM_WIDTH, CAM_HEIGHT);
        */
