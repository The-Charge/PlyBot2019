...
public class LineDiscover extends Command {
    ...
    protected void execute() {
        ...
        int lasen = -1; //The last sensor to be turned on
        ...
        if(state == 2){ //Calculation phase
            if(lasen == 0 && tod[1] != 0){ //Left edge sensor if to prevent NOOB exception
                angle = Math.atan((tod[0] - tod[1])/(sensdist/inpsec));// * (180 / Math.PI);
            }
            else if(lasen == 4 && tod[3] != 0){ //Right edge sensor if to prevent NOOB exception
