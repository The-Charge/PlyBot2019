...
public class TurnToVisionTarget extends PIDCommand {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
        ...
        super("TurnToVisionTarget", 1.0, 0.0, 0.0, 0.02);
    ...
    protected double returnPIDInput() {
        ...
        String serialInfo = VisionUtil.readSerialPort(Robot.visionPort);
        VisionData camInfo = VisionUtil.parseMessage(serialInfo);
