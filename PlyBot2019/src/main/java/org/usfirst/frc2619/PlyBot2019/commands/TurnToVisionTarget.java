...
public class TurnToVisionTarget extends PIDCommand {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
        super("TurnToVisionTarget",  0.01, 0.0, 0.0, 0.02);
    ...
    protected double returnPIDInput() {
        ...
        SmartDashboard.putString("Command VisionData", camInfo.toString());
        SmartDashboard.putNumber("Command Angle to closest target", camInfo.findClosestTargetYaw());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=OUTPUT
        try {
            ...
            System.out.println("camInfo not valid");
            Robot.driveTrain.run(0.0, 0.0);
        }
    }
    ...
    protected boolean isFinished() {
        //return getPIDController().onTarget(); //not needed currently
        return false;
    }
