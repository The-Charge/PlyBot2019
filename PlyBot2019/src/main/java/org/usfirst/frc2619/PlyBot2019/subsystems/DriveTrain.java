...
public class DriveTrain extends Subsystem {
    ...
    private final double POSITION_I = 0;//  |--All 4 of these need tuning
    private final double POSITION_D = 0;//  |
    private final double POSITION_F = 0;//__/
	...
	public void driveXFeet_PID(double distance) {
		...
		leftFrontMotor.config_kP(1, POSITION_P, TIMEOUT_MS);
    	leftFrontMotor.config_kI(1, POSITION_I, TIMEOUT_MS);
    	leftFrontMotor.config_kD(1, POSITION_D, TIMEOUT_MS);
		leftFrontMotor.config_kF(1, POSITION_F, TIMEOUT_MS);
		
		rightFrontMotor.config_kP(1, POSITION_P, TIMEOUT_MS);
    	rightFrontMotor.config_kI(1, POSITION_I, TIMEOUT_MS);
    	rightFrontMotor.config_kD(1, POSITION_D, TIMEOUT_MS);
		rightFrontMotor.config_kF(1, POSITION_F, TIMEOUT_MS);
