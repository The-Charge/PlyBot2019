...
public class SensorBar extends Subsystem {
    ...
    public final DigitalInput[] SensBar = {sensorFarLeft, sensorLeft, sensorMiddle, sensorRight, sensorFarRight}; //Allow for easier access to sensor output instead of one at a time
