...
public class SensorBar extends Subsystem {
    ...
    public DigitalInput sensBar[] = new DigitalInput[5]; //Allow for easier access to sensor output instead of one at a time
    ...
    public void periodic() {
        ...
        //SmartDashboard.putBoolean("Sensor 1 On", sensorLeft.get());
