...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("TurnNDegreesRelativePID: Turn90DegreesRelativePID", new TurnNDegreesRelativePID(90));
        SmartDashboard.putData("ToggleQuarterSpeed", new ToggleQuarterSpeed());
        SmartDashboard.putData("ToggleHalfSpeed", new ToggleHalfSpeed());
