...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("ExtendSolenoidKicker: isExtended", new ExtendSolenoidKicker(false));
        SmartDashboard.putData("RetractSolenoidKicker: isExtended", new RetractSolenoidKicker(false));
        SmartDashboard.putData("InvertDrive: isReversed", new InvertDrive(false));
