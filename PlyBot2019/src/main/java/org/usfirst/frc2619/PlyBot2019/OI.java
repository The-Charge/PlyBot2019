...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("TurnNDegreesAbsolutePID: Turn270DegreesAbsolutePID", new TurnNDegreesAbsolutePID(270));
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        //SmartDashboard.putData("Turn to 0 Degrees Absolute PID", new TurnNDegreesAbsolutePID(0));
        //SmartDashboard.putData("Turn to 180 Degrees Absolute PID", new TurnNDegreesAbsolutePID(180));
        //SmartDashboard.putData("Turn to 90 Degrees Absolute PID", new TurnNDegreesAbsolutePID(90));
        //SmartDashboard.putData("Turn to 270 Degrees Absolute PID", new TurnNDegreesAbsolutePID(270));
    }
