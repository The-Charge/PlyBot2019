...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("TurnToVisionTarget", new TurnToVisionTarget());
        SmartDashboard.putData("LockOnTargetDrive", new LockToTargetTankDrive());
        SmartDashboard.putData("LockToTargetTankDrive", new LockToTargetTankDrive());
