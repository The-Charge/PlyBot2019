...
public class OI {
    ...
    public OI() {
        ...
        intakeOutSlowBtn.whileHeld(new IntakeOutSlow());
        intakeOutFastBtn = new JoystickButton(buttonBox, 6);
        intakeOutFastBtn.whileHeld(new IntakeOutFast());
        intakeInSlowBtn = new JoystickButton(buttonBox, 3);
        intakeInSlowBtn.whileHeld(new IntakeInSlow());
        intakeInFastBtn = new JoystickButton(buttonBox, 5);
        intakeInFastBtn.whileHeld(new IntakeInFast());
